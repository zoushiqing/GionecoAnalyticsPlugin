...
class GionecoAnalyticsDefaultMethodVisitor extends AdviceAdapter {

   GionecoAnalyticsDefaultMethodVisitor(MethodVisitor mv, int access, String name, String desc) {

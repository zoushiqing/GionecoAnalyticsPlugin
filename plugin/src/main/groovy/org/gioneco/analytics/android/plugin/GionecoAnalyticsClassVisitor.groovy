...
class GionecoAnalyticsClassVisitor extends ClassVisitor implements Opcodes {
    ...
    private HashMap<String, GionecoAnalyticsMethodCell> mLambdaMethodCells = new HashMap<>()

    GionecoAnalyticsClassVisitor(final ClassVisitor classVisitor) {
    ...
    MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        methodVisitor = new GionecoAnalyticsDefaultMethodVisitor(methodVisitor, access, name, desc) {
            ...
            void visitInvokeDynamicInsn(String name1, String desc1, Handle bsm, Object... bsmArgs) {
                Object.visitInvokeDynamicInsn(name1, desc1, bsm, bsmArgs)

                try {
                    String desc2 = (String) bsmArgs[0]
                    GionecoAnalyticsMethodCell sensorsAnalyticsMethodCell = GionecoAnalyticsHookConfig.LAMBDA_METHODS.get(Type.getReturnType(desc1).getDescriptor() + name1 + desc2)
            ...
            protected void onMethodEnter() {
                 ...
                 */
                GionecoAnalyticsMethodCell lambdaMethodCell = mLambdaMethodCells.get(nameDesc)
                if (lambdaMethodCell != null) {
                    ...
                    boolean isStaticMethod = GionecoAnalyticsUtils.isStatic(access)
                    if (!isStaticMethod) {
